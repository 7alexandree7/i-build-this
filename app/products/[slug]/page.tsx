...
import VottingButton from "@/components/products/voting-button/votting-button";
    ...
    return (
        <div className="py-16">
            <div className="wrapper">
                <Link href="/explore" className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-8">
                        ...
                        <div className="sticky top-24 space-y-4">
                            <div className="border rounded-lg p-6 bg-background">
                                <div className="text-center mb-6">
                                    <p className=" text-sm text-muted-foreground mb-2">Support this product</p>
                                    <VottingButton productId={product.id} productVoteCount={voteCount} />
                                </div>
                                {voteCount > 100 && (
